...
import com.example.demo.hl.component.ActionImageButton;
...
//			} else
			if (position == 0) {
				...
				Toast.makeText(getActivity(), "Restaurants", Toast.LENGTH_LONG).show();
				Intent itMain = new Intent(getActivity(), MainActivity.class);
                itMain.putExtra(MainActivity.INTENT_VAR_CURRENT_CONTENT, MainActivity.DOUJIN_LIST);
                itMain.putExtra(MainActivity.INTENT_VAR_URL, Constants.SITERESTAURANT);
                getActivity().startActivityForResult(itMain, 1);
				
			} else if (bean.getDescription().equals("Hotels")) {
				Toast.makeText(getActivity(), "Hotels", Toast.LENGTH_LONG).show();
				Intent itMain = new Intent(getActivity(), MainActivity.class);
                itMain.putExtra(MainActivity.INTENT_VAR_CURRENT_CONTENT, MainActivity.DOUJIN_LIST);
                itMain.putExtra(MainActivity.INTENT_VAR_URL, Constants.SITEHOTEL);
                getActivity().startActivityForResult(itMain, 1);
                
			} else if (bean.getDescription().equals("Attractions")) {
				Toast.makeText(getActivity(), "Attractions", Toast.LENGTH_LONG).show();
				
			} else if (bean.getDescription().equals("Nightlife")) {
				Toast.makeText(getActivity(), "Nightlife", Toast.LENGTH_LONG).show();
				Intent itMain = new Intent(getActivity(), MainActivity.class);
                itMain.putExtra(MainActivity.INTENT_VAR_CURRENT_CONTENT, MainActivity.DOUJIN_LIST);
                itMain.putExtra(MainActivity.INTENT_VAR_URL, Constants.SITEBAR);
                getActivity().startActivityForResult(itMain, 1);
				
			} else if (bean.getDescription().equals("Shopping")) {
				Toast.makeText(getActivity(), "Shopping", Toast.LENGTH_LONG).show();
			} else if (bean.getDescription().equals("Air Ticket")) {
				Toast.makeText(getActivity(), "Air Ticket", Toast.LENGTH_LONG).show();
